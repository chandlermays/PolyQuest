...
{
    /* -------------------------------------------------------------------------------------------------------
     * Role: Provides a custom Unity Editor inspector for designing enemy progression.                       *
     *                                                                                                       *
     * Responsibilities:                                                                                     *
     *      - Displays and edits enemy experience reward progression values.                                 *
    ...
    [CustomEditor(typeof(EnemyProgression), true)]
    public class EnemyProgressionEditor : BaseProgressionEditor
    {
        ...
        /*-------------------------------------------------------------------------------------------
        | --- DisplaySubclassFields: Display Enemy-Specific Experience Reward Fields --- |
        -------------------------------------------------------------------------------------------*/
        protected override void DisplaySubclassFields()
        {
            ...
            DisplayRecalculateButton(kRecalculateExperienceRewardButton,
                () => ((EnemyProgression)target).RecalculateExperienceRewardAmounts());
        }

        /*-------------------------------------------------------------------------------------------
        | --- DisplaySubclassArrays: Display Enemy-Specific Experience Reward Arrays --- |
        -------------------------------------------------------------------------------------------*/
        ...
        /*-------------------------------------------------------------------------------------------
        | --- AddLevelToSubclassArrays: Add a Level to Enemy Experience Reward Arrays --- |
        -------------------------------------------------------------------------------------------*/
        ...
        /*-------------------------------------------------------------------------------------------
        | --- RemoveLevelFromSubclassArrays: Remove a Level from Enemy Experience Reward Arrays --- |
        -------------------------------------------------------------------------------------------*/
