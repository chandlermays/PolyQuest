...
{
    [CreateAssetMenu(fileName = "NewEnemyProgression", menuName = "PolyQuest/Progression/New Enemy Progression", order = 1)]
    public class EnemyProgression : BaseProgression
    {
        ...
        /*----------------------------------------------------------------------------------------------------------------- 
        | --- RecalculateExperienceRewardAmounts: Recalculate the Experience Reward Amounts for the Enemy Progression --- |
        -----------------------------------------------------------------------------------------------------------------*/
        ...
        /*-------------------------------------------------------------------------------------------------------- 
        | --- GetExperienceReward: Returns the Experience Reward Amount for the Specified Level of the Enemy --- |
        --------------------------------------------------------------------------------------------------------*/
